...
const allRules: RuleEntry[] = [
  ...
  { id: "R32", name: "Interface Parent Removed", target: "interface", severity: "breaking", languages: "TS, Java, Go, Rust", description: "An interface stops extending one of its previous parent interfaces/traits. Callers relying on properties or methods inherited from the removed parent lose that compatibility.", example: "interface Foo extends Base -> interface Foo" },
];
